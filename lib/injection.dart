...
void init() {
  // bloc provider
  locator.registerFactory(() => DetailBlocMovie(locator(), locator(), locator(), locator(), locator()));
  ...
  locator.registerFactory(() => DetailBlocTv(locator(), locator(), locator(), locator(), locator()));
